...
/** Устарело: заказы не удаляются из bot-orders.json. */
export async function removeSiteBotOrderSnapshot(_orderId: string): Promise<void> {
  /* no-op — журнал заказов хранится всегда */
}
